...
//        $the_object->user_password= $found_user['user_password'];
        ...
        foreach ($the_record as $the_object_key => $value){
            if($the_object-> has_the_property($the_object_key)){
                $the_object->$the_object_key = $value;
            }
        }
        return $the_object;
    }

    private function has_the_property($the_object_key){
        $object_properties=get_object_vars($this);
        return array_key_exists($the_object_key, $object_properties);
